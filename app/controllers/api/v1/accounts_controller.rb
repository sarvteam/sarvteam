class Api::V1::AccountsController < Api::BaseController
  ...
  def show
    @latest_sarvteam_version = ::Redis::Alfred.get(::Redis::Alfred::LATEST_SARVTEAM_VERSION)
  ...
  def validate_captcha
    raise ActionController::InvalidAuthenticityToken, 'Invalid Captcha' unless SarvTeamCaptcha.new(params[:h_captcha_client_response]).valid?
  end
