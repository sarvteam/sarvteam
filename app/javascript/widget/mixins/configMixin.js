export default {
  computed: {
    ...
    hasAConnectedAgentBot() {
      return !!window.sarvteamWebChannel.hasAConnectedAgentBot;
    },
    inboxAvatarUrl() {
      return window.sarvteamWebChannel.avatarUrl;
    },
    channelConfig() {
      return window.sarvteamWebChannel;
    },
    ...
    preChatFormEnabled() {
      return window.sarvteamWebChannel.preChatFormEnabled;
    },
    preChatFormOptions() {
      let preChatMessage = '';
      const options = window.sarvteamWebChannel.preChatFormOptions || {};
