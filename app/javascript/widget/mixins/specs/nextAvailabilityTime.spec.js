...
describe('nextAvailabilityTimeMixin', () => {
  ...
  beforeAll(() => {
    window.sarvteamWebChannel = sarvteamWebChannel;
  });

  afterAll(() => {
    delete window.sarvteamWebChannel;
  });
  ...
  it('should return channelConfig', () => {
    ...
    const vm = new Constructor().$mount();
    const wrapper = createWrapper(vm);
    expect(wrapper.vm.channelConfig).toEqual(sarvteamWebChannel);
  });
  ...
  it('should return workingHours', () => {
    ...
    const vm = new Constructor().$mount();
    const wrapper = createWrapper(vm);
    expect(wrapper.vm.workingHours).toEqual(sarvteamWebChannel.workingHours);
  });
  ...
  it('should return currentDayWorkingHours', () => {
    ...
    const expectedWorkingHours = sarvteamWebChannel.workingHours.find(
  ...
  it('should return hoursAndMinutesBackInOnline', () => {
    ...
    const currentDayCloseHour =
      sarvteamWebChannel.workingHours[wrapper.vm.currentDay].close_hour;
    const nextDayOpenHour =
      sarvteamWebChannel.workingHours[
  ...
  it('should return in 30 minutes', () => {
    ...
    sarvteamWebChannel.workingHours[4].open_hour = 18;
    sarvteamWebChannel.workingHours[4].open_minutes = 0;
    sarvteamWebChannel.workingHours[4].close_hour = 23;
  ...
  it('should return in 3 hours', () => {
    ...
    sarvteamWebChannel.workingHours[4].open_hour = 19;
  ...
  it('should return at 10:00 AM', () => {
    ...
    sarvteamWebChannel.workingHours[4].open_hour = 10;
  ...
  it('should return tomorrow', () => {
    ...
    sarvteamWebChannel.workingHours[4].open_hour = 9;
    sarvteamWebChannel.workingHours[4].close_hour = 16;
  ...
  it('should return on Saturday', () => {
    ...
    sarvteamWebChannel.workingHours[4].open_hour = 9;
    sarvteamWebChannel.workingHours[4].close_hour = 16;
    sarvteamWebChannel.workingHours[5].closed_all_day = true;
