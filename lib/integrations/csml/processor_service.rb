class Integrations::Csml::ProcessorService < Integrations::BotProcessorService
  ...
  def client_params(session_id)
    {
      bot_id: "sarvteam-bot-#{conversation.inbox.id}",
      channel_id: "sarvteam-bot-inbox-#{conversation.inbox.id}",
      user_id: session_id
    }
  end
  ...
  def bot_payload
    {
      id: "sarvteam-csml-bot-#{agent_bot.id}",
      name: "sarvteam-csml-bot-#{agent_bot.id}",
      default_flow: 'sarvteam_bot_flow',
      flows: [
        {
          id: "sarvteam-csml-bot-flow-#{agent_bot.id}-inbox-#{conversation.inbox.id}",
          name: 'sarvteam_bot_flow',
